...
const CREDIT_ENTRY_API = '/credit_entry.php';
...
export default function CreditEntryForm() {
  ...
  const [errors, setErrors] = useState<Partial<Record<keyof CreditEntryData, string>>>({});
  ...
  const validateForm = () => {
    const newErrors: Partial<Record<keyof CreditEntryData, string>> = {};
    ...
    <View style={styles.container}>
      ...
      {showSuccess && (
        <View style={styles.overlay}>
          <View style={styles.successContainer}>
            ...
            <Text style={styles.successText}>Credit Entry Submitted Successfully!</Text>
          </View>
        </View>
      )}
      ...
      {showError && (
        <View style={styles.overlay}>
          <View style={styles.errorContainer}>
            ...
            <Text style={styles.overlayErrorText}>Failed to submit credit entry. Please try again.</Text>
          </View>
        </View>
      )}
      ...
      <View style={styles.formCard}>
        <View style={styles.cardHeader}>
          <Text style={styles.formTitle}>Add Credit Entry</Text>
